.data
    ...
    error_msg: .asciiz "Invalid input! Please enter a non-negative number.\n"
...
#    Total Sum: 15, Average: 7
#
# Note: The program validates input
# and handles negative numbers 